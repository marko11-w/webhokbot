...
def show_help(message):
    bot.send_message(message.chat.id,
        "📌 *تعليمات الاستخدام:*\n\n"
        "1. أرسل رابط فيديو من TikTok أو YouTube أو Instagram أو Pinterest...\n"
        "2. انتظر قليلاً ليتم تحميله 🎬\n"
        "3. سيصلك الفيديو مباشرة ✅",
        parse_mode="Markdown")
...
def handle_link(message):
    ...
    if path and os.path.exists(path):
        try:
            ...
            bot.send_message(user_id, "❌ حدث خطأ أثناء إرسال الفيديو.")
    else:
